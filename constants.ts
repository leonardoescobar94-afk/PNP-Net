...
export const TEXTS = {
  es: {
    ...
    footerPurpose: "Clinimetría para uso por especialistas en medicina electrodiagnóstica (especialistas en Medicina Física y Rehabilitación o neurólogos).",
  ...
  en: {
    ...
    footerPurpose: "Clinimetrics for use by electrodiagnostic medicine specialists (Physical Medicine and Rehabilitation specialists or neurologists).",
