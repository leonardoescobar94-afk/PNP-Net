...
export const TEXTS = {
  es: {
    ...
    whenToUseText: "Aplicar como herramienta de apoyo en adultos de 19 a 79 años con diabetes mellitus conocida o con sospecha clínica de polineuropatía diabética distal simétrica. Los resultados deben interpretarse en conjunto con la historia clínica, el examen neurológico y el estudio electrodiagnóstico completo.",
    references: "Referencias",
    development: "Desarrollo",
    footerPurpose: "Clinimetría para uso por especialistas en Medicina Física y Rehabilitación.",
  ...
  en: {
    ...
    whenToUseText: "Use as a supportive tool in adults aged 19 to 79 years with known diabetes mellitus or clinical suspicion of distal symmetric diabetic polyneuropathy. Results must be interpreted together with the clinical history, neurological examination, and complete electrodiagnostic study.",
    references: "References",
    development: "Development",
    footerPurpose: "Clinimetrics for use by specialists in Physical Medicine and Rehabilitation.",
